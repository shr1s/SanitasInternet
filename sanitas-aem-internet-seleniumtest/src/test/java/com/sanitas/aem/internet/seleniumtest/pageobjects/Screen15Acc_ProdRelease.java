...
public class Screen15Acc_ProdRelease extends AbstractStepInternet {

    public Screen15Acc_ProdRelease(WebDriver driver, TimeHelper timeHelper) {
    ...
    public void compareMiniTeasers(){
        plusButton();
        closeButton();
        waitTillLoad();
        leftShiftArrow();
